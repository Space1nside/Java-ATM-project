...
class BankTest {
    ...
    //Should return null if holder with this account number already exists
    @Test
    void addSimilarHolder() {
        Account newAcc = bank.addHolder("Mike", "Wazovsky", 123456789, 9900, 3456);
        Assertions.assertNull(newAcc, "Such account already exists, but it was added anyway");
    }
    ...
    void addNewHolder() {
        ...
        Assertions.assertNotNull(newAcc, "Such account doesn't exist, but it was not added");
    }
    ...
    void checkCorrectLogin() {
        ...
        Assertions.assertNotNull(checkLogin, "The login was correct, but method returned null");
    }
    ...
    void checkIncorrectLogin() {
        ...
        Assertions.assertNull(checkLogin, "Login wasn't correct, but method returned account");
    }
    ...
    void checkIncorrectPin() {
        ...
        Assertions.assertNull(checkLogin, "Account number was correct but pin wasn't, but method returned account");
    }
    ...
    void checkIncorrectAccNum() {
        Account checkLogin = bank.checkLogin(123456789, 6547);
        Assertions.assertNull(checkLogin, "Pin was correct but account number wasn't, but method returned account");
    }
    ...
    void hasAccount() {
        ...
        Assertions.assertNotNull(account, "Such account number exists, but it was not found");
    }
    ...
    void noHasAccount() {
        ...
        Assertions.assertNull(account, "Such account number doesn't exist, but it was found");
    }
}